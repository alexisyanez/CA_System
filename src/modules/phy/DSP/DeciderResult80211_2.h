...
#ifndef DECIDERRESULT80211_2_H_
#define DECIDERRESULT80211_2_H_
 ...
 * @ingroup ieee80211
 */
class MIXIM_API DeciderResult80211_2 : public DeciderResult{
protected:
...
public:
	 ...
	 */
	DeciderResult80211_2(bool isCorrect, double bitrate, double snr, double recvPower_dBm = 0, bool collision = false):
