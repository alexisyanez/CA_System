...
#ifndef DECIDER80211p2_H_
#define DECIDER80211p2_H_
 ...
 * @see Decider80211p
 */
class Decider80211p2: public BaseDecider {
	public:
	...
	protected:
		...
		std::string myPath;
		Decider80211pToPhy80211p2Interface* phy11p;
	...
	public:
		 ...
		 */
		Decider80211p2(DeciderToPhyInterface* phy,
		              double sensitivity,
		              double ccaThreshold,
		              bool allowTxDuringRx,
		              double centerFrequency,
			...
			collisions(0) {
			phy11p = dynamic_cast<Decider80211pToPhy80211p2Interface*>(phy);
			assert(phy11p);
