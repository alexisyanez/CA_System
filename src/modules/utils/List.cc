...
{
    Nodelist<T> *new_node = new Nodelist<T> (data_);
    Nodelist<T> *temp = m_head;
...
{
    Nodelist<T> *temp = m_head;
    Nodelist<T> *temp2 = list_2.m_head;
...
{
    T temp_data;
    Nodelist<T> *aux_node = m_head;
    Nodelist<T> *temp = aux_node;
