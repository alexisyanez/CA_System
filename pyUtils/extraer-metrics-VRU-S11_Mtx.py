...
for l in range(0,2):	
	for k in range(0,4):
		...
		for i in range(0,5): #(0,10):
			...
			PKT_Total_Send = []
			#List1 = [[],[]]
			name= Pathresults + namePrefix + Conf + DEN[l] + rtx[k] + "-#" + str(i) + ".sca" #  "BL="+ Interval[k]+"," + Interval[k]+","+ Interval[k]+"," + Interval[k]  +"-#" + str(i) + ".sca" #DEN[l] + "BL="+ Interval[k] + END[l]  +"-#" + str(i) + ".sca" 
...
out = "MeanMetrics-MultipleTx-S11-V2"
